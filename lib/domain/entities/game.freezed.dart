...
mixin _$Game {
 ...
 Board get board; Mark get currentPlayer;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Game&&(identical(other.board, _this.board) || other.board == _this.board)&&(identical(other.currentPlayer, _this.currentPlayer) || other.currentPlayer == _this.currentPlayer));
}
...
int get hashCode {
  final _this = this as Game;
  return Object.hash(runtimeType,_this.board,_this.currentPlayer);
}

@override
String toString() {
  final _this = this as Game;
  return 'Game(board: ${_this.board}, currentPlayer: ${_this.currentPlayer})';
}
...
@useResult
$Res call({
 Board board, Mark currentPlayer
});
...
/// Create a copy of Game
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? board = null,Object? currentPlayer = null,}) {
  return _then(Game(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Board board,  Mark currentPlayer)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Game() when $default != null:
return $default(_that.board,_that.currentPlayer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Board board,  Mark currentPlayer)  $default,) {final _that = this;
switch (_that) {
case _Game():
return $default(_that.board,_that.currentPlayer);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Board board,  Mark currentPlayer)?  $default,) {final _that = this;
switch (_that) {
case _Game() when $default != null:
return $default(_that.board,_that.currentPlayer);case _:
  return null;
...
class _Game extends Game {
  const _Game({required this.board, required this.currentPlayer}): super._();
  

@override final  Board board;
@override final  Mark currentPlayer;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Game&&(identical(other.board, board) || other.board == board)&&(identical(other.currentPlayer, currentPlayer) || other.currentPlayer == currentPlayer));
}


@override
int get hashCode {
    return Object.hash(runtimeType,board,currentPlayer);
}
...
/// Create a copy of Game
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? board = null,Object? currentPlayer = null,}) {
  return _then(_Game(
board: null == board ? _self.board : board // ignore: cast_nullable_to_non_nullable
as Board,currentPlayer: null == currentPlayer ? _self.currentPlayer : currentPlayer // ignore: cast_nullable_to_non_nullable
as Mark,
